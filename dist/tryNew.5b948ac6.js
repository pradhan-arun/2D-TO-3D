...
})({"dh72S":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "dc03af065b948ac6";
"use strict";
...
},{}],"g6Hiw":[function(require,module,exports) {
...
scene.add(new _three.AxesHelper(5));
const light = new _three.DirectionalLight(0xffffff, Math.PI);
...
const helper = new _three.CameraHelper(light.shadow.camera);
scene.add(helper);
...
new (0, _orbitControls.OrbitControls)(camera, renderer.domElement);
const planeGeometry = new _three.PlaneGeometry(100, 20);
const plane = new _three.Mesh(planeGeometry, new _three.MeshPhongMaterial());
plane.rotateX(-Math.PI / 2);
plane.position.y = -1.75;
plane.receiveShadow = true;
scene.add(plane);
const torusGeometry = [
    new _three.TorusGeometry(),
    new _three.TorusGeometry(),
    new _three.TorusGeometry(),
    new _three.TorusGeometry(),
    new _three.TorusGeometry()
...
const material = [
    ...
    new _three.MeshPhysicalMaterial({}),
    new _three.MeshToonMaterial()
];
const torus = [
    new _three.Mesh(torusGeometry[0], material[0]),
    new _three.Mesh(torusGeometry[1], material[1]),
    new _three.Mesh(torusGeometry[2], material[2]),
    new _three.Mesh(torusGeometry[3], material[3]),
    new _three.Mesh(torusGeometry[4], material[4])
];
const texture = new _three.TextureLoader().load((0, _allImage.image1));
...
directionalLightFolder.add(data, "shadowMapSizeWidth", [
    256,
    512,
    1024,
    2048,
...
directionalLightFolder.add(data, "shadowMapSizeHeight", [
    256,
    512,
    1024,
    2048,
...
meshesFolder.add(data, "mapsEnabled").onChange(()=>{
    material.forEach((m)=>{
        if (data.mapsEnabled) m.map = texture;
        else m.map = null;
        m.needsUpdate = true;
    });
});
...
},{"three":"ktPTu","three/examples/jsm/controls/OrbitControls":"7mqRv","three/examples/jsm/libs/stats.module":"6xUSB","dat.gui":"k3xQk","../assets/AllImage":"h1oCP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k3xQk":[function(require,module,exports) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dh72S","g6Hiw"], "g6Hiw", "parcelRequire20bc")

//# sourceMappingURL=tryNew.5b948ac6.js.map
