...
},{}],"fM4b8":[function(require,module,exports) {
...
let mesh = new _three.Mesh(cube, material);
scene.add(mesh);
...
function detectFloor() {
    ...
    const floorGeometry = new _three.PlaneGeometry(100, 100);
    const floorMaterial = new _three.MeshBasicMaterial({
        color: 0x00ff00,
        side: _three.DoubleSide
    });
    floorPlane = new _three.Mesh(floorGeometry, floorMaterial);
